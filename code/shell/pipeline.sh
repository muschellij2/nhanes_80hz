...
Rnosave code/R/06_output_aggregate_ac_lfe.R -J ACAGG --mem=30G -o %x_%A.out -e %x_%A.err
...
Rnosave code/R/05_output_run_asleep.R -J SLEEP --array=6-200 --mem=35G -o %x_%A_%a.out -e %x_%A_%a.err --time=4-00:00:00
...
Rnosave code/R/999_check_min_times.R -J CHECK --array=1-200 --mem=6G -o %x_%A_%a.out -e %x_%A_%a.err
