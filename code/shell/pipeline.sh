...
Rnosave code/R/run_stepcount.R -J STEPCOUNT --array=11-200 --mem=30G -o %x_%A_%a.out -e %x_%A_%a.err
...
Rnosave data/lily/code/run_adept_1001_2000.R -J ADEPT --nodes=1 --ntasks=1 --cpus-per-task=8  --array=11-20 --mem=100G -o %x_%A_%a.out -e %x_%A_%a.err
# --exclude=compute-115
